...
public class FilmController {
    ...
    public String getDetail(String ISDN, Model model) {
    ...
    public String selectfilmByISDN(String ISDN, Model model) {
        List<film> films = filmService.AllFilm();
        for (film film : films) {
            if (film.getISDN() == Integer.valueOf(ISDN)) {
    ...
    @RequestMapping("/sfByi")
    public String selectfilmByI(String ISDN, Model model) {
        List<film> films = filmService.AllFilm();
        if ("".equals(ISDN)) {
            model.addAttribute("allfilms", films);
            return "film/Film_pre.jsp";
        ...
        for (film film : films) {
            if (String.valueOf(film.getISDN()).equals(ISDN)) {
                List<film> films1 = filmService.selectfilmByISDN(ISDN);
                model.addAttribute("allfilms", films1);
                return "film/Film_pre.jsp";
            }
        }
        model.addAttribute("allfilms", new ArrayList());
        return "film/Film_pre.jsp";
    }
